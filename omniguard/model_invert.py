...
import omniguard.config as c
from omniguard.hinet import Hinet, InvertibleTransform
# from trustmark import TrustMark
from omniguard.unet import Unet1, SecretDecoder
...
import omniguard.modules.Unet_common as common
dwt = common.DWT()
iwt = common.IWT()
...
class Model(nn.Module):
    def __init__(self, checkpoint):
        ...
        ck1 = torch.load(os.path.join(checkpoint, 'encoder_Q.ckpt'))
        ...
        ck2 = torch.load(os.path.join(checkpoint, 'decoder_Q.ckpt'))
