...
class Params:
    ...
    def __init__(self):
        ...
        self.vae_model_name = "sd-legacy/stable-diffusion-inpainting" #"stabilityai/stable-diffusion-2-1"
        ...
        self.noisy_type = "vae_roundtrip"  # "latent_masked" | "vae_roundtrip" | "latent_full"
