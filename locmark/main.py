...
class Params:
    ...
    def __init__(self):
        ...
        self.exp_name = 'pgd-linf-exp5' # NOTE: L∞ PGD with ε=0.1
        ...
        self.lr = 0.02  # Step size for L∞ PGD (Option C: α ≈ 2.5×ε/T)
        self.steps = 300
        self.lambda_p = 0.003 #0.05 #0.025
        self.lambda_i = 0.003 #0.01 #0.005
        self.feat_layer = 1
        self.epsilon = 0.8  # L∞ bound in latent space
